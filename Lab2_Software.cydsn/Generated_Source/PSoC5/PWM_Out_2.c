...
{
    uint8 staticBits = (PWM_Out_2_DR & (uint8)(~PWM_Out_2_MASK));
    PWM_Out_2_DR = staticBits | ((uint8)(value << PWM_Out_2_SHIFT) & PWM_Out_2_MASK);
}
...
{
	CyPins_SetPinDriveMode(PWM_Out_2_0, mode);
}
...
{
    return (PWM_Out_2_PS & PWM_Out_2_MASK) >> PWM_Out_2_SHIFT;
}
...
{
    return (PWM_Out_2_DR & PWM_Out_2_MASK) >> PWM_Out_2_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(PWM_Out_2_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & PWM_Out_2_0_INTR) != 0u) 
		{ 
			 PWM_Out_2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (PWM_Out_2_INTSTAT & PWM_Out_2_MASK) >> PWM_Out_2_SHIFT;
    }
