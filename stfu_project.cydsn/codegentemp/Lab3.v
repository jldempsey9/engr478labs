...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=1, VDAC_Range=0, VDAC_Speed=2, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WaveDAC8_1:VDAC8, CY_INSTANCE_SHORT_NAME=VDAC8, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=WaveDAC8_1_VDAC8, )
...
module WaveDAC8_v2_10_3 (
	...
	cy_clock_v1_0
		#(.id("61e89393-4c4c-49d4-9180-5220f842e0e3/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("10000000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__LED_Out_Pin_net;
	wire [0:0] tmpFB_0__LED_Out_Pin_net;
	wire [0:0] tmpIO_0__LED_Out_Pin_net;
	wire [0:0] tmpINTERRUPT_0__LED_Out_Pin_net;
	electrical [0:0] tmpSIOVREF__LED_Out_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5c3915a2-7800-416d-b2c8-a130a19172cf"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_Out_Pin
		 (.oe(tmpOE__LED_Out_Pin_net),
		  .y({Net_254}),
		  .fb({tmpFB_0__LED_Out_Pin_net[0:0]}),
		  .io({tmpIO_0__LED_Out_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_Out_Pin_net),
		  .interrupt({tmpINTERRUPT_0__LED_Out_Pin_net[0:0]}),
		  .annotation({Net_1281}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__LED_Out_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CyControlReg_v1_80 Debug_LED_ctrl (
        .control_1(Net_113),
        .control_2(Net_114),
        .control_3(Net_115),
        .control_0(Net_254),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Debug_LED_ctrl.Bit0Mode = 0;
    defparam Debug_LED_ctrl.Bit1Mode = 0;
    defparam Debug_LED_ctrl.Bit2Mode = 0;
    defparam Debug_LED_ctrl.Bit3Mode = 0;
    defparam Debug_LED_ctrl.Bit4Mode = 0;
    defparam Debug_LED_ctrl.Bit5Mode = 0;
    defparam Debug_LED_ctrl.Bit6Mode = 0;
    defparam Debug_LED_ctrl.Bit7Mode = 0;
    defparam Debug_LED_ctrl.BitValue = 0;
    defparam Debug_LED_ctrl.BusDisplay = 0;
    defparam Debug_LED_ctrl.ExtrReset = 0;
    defparam Debug_LED_ctrl.NumOutputs = 1;
	...
	cy_clock_v1_0
		#(.id("fb457f31-3a3b-4577-8005-a2878df2eff1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("125000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__PWM_Pin_net;
	wire [0:0] tmpFB_0__PWM_Pin_net;
	wire [0:0] tmpIO_0__PWM_Pin_net;
	wire [0:0] tmpINTERRUPT_0__PWM_Pin_net;
	electrical [0:0] tmpSIOVREF__PWM_Pin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PWM_Pin
		 (.oe(tmpOE__PWM_Pin_net),
		  .y({Net_420}),
		  .fb({tmpFB_0__PWM_Pin_net[0:0]}),
		  .io({tmpIO_0__PWM_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_Pin_net),
		  .interrupt({tmpINTERRUPT_0__PWM_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("6865befe-f850-4002-b63d-6d3330e4d463"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("250000000"),
		  .is_direct(0),
    ...
    PWM_v3_30_5 Speaker_PWM (
        ...
        .ph1(Net_2813),
        .ph2(Net_2814));
    defparam Speaker_PWM.Resolution = 16;

	wire [0:0] tmpOE__Speaker_Pin_net;
	wire [0:0] tmpFB_0__Speaker_Pin_net;
	wire [0:0] tmpIO_0__Speaker_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Speaker_Pin_net;
	electrical [0:0] tmpSIOVREF__Speaker_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("26bf3e85-e1d6-4947-ae98-0374638e3c0e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Speaker_Pin
		 (.oe(tmpOE__Speaker_Pin_net),
		  .y({Net_1399}),
		  .fb({tmpFB_0__Speaker_Pin_net[0:0]}),
		  .io({tmpIO_0__Speaker_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Speaker_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Speaker_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Speaker_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
