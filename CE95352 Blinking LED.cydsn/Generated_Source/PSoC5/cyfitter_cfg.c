...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 2048u, 0x12u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_U0_BASE) },	/* TD 17 */
		{ 256u, 0x13u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE) },	/* TD 18 */
		{ 256u, 0x14u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI4_BASE) },	/* TD 19 */
		{ 128u, 0x15u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI6_BASE) },	/* TD 20 */
		{ 768u, 0x16u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI7_BASE) },	/* TD 21 */
		{ 512u, 0x17u, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI12_BASE) },	/* TD 22 */
		...
		{ 12u, 0x1Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_TMR0_CFG0) },	/* TD 25 */
		{ 12u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_TMR1_CFG0) },	/* TD 26 */
		...
		{ 128u, 0x1Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI5_BASE) },	/* TD 29 */
		{ 128u, 0x1Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI5_BASE + 0x00000080u) },	/* TD 30 */
		{ 128u, 0x20u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_ROUTE_BASE + 0x00000080u) },	/* TD 31 */
		{ 128u, 0x21u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_ROUTE_BASE + 0x00000080u) },	/* TD 32 */
		{ 128u, 0x22u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE) },	/* TD 33 */
		{ 128u, 0x23u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_ROUTE_BASE + 0x00000080u) },	/* TD 34 */
		{ 128u, 0x24u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE) },	/* TD 35 */
		...
		{ 128u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI1_BASE + 0x00000080u) },	/* TD 40 */
	};
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_TMR0_VAL),	/* TD 25 */
		(const void *)(BS_TMR1_VAL),	/* TD 26 */
		(const void *)(BS_UDB_0_4_0_CONFIG_VAL),	/* TD 27 */
		(const void *)(BS_DSI0_3_HV_ROUTING_VAL),	/* TD 28 */
		(const void *)(BS_DSISWITCH_0_4_VAL),	/* TD 29 */
		(const void *)(BS_DSI0_4_HV_ROUTING_VAL),	/* TD 30 */
		(const void *)(BS_UDB_1_3_HV_ROUTING_VAL),	/* TD 31 */
		(const void *)(BS_UDB_2_3_HV_ROUTING_VAL),	/* TD 32 */
		(const void *)(BS_UDBSWITCH_0_4_VAL),	/* TD 33 */
		(const void *)(BS_UDB_1_4_HV_ROUTING_VAL),	/* TD 34 */
		(const void *)(BS_DSISWITCH_1_2_VAL),	/* TD 35 */
	...
	CY_SET_REG16((void CYXDATA *)CYREG_PHUB_TDMEM0_ORIG_TD0, 40u*8u);	/* transfer size */
